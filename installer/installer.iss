...
[Run]
Filename: "{cmd}"; WorkingDir: "{app}"; Parameters: "/C timeout /T 4 /NOBREAK > NUL & start \"\" \"{app}\{#MyAppExeName}\""; Description: "{cm:LaunchProgram,{#MyAppName}}"; Flags: nowait postinstall skipifsilent runhidden
